          ...
          {(() => {
            ...
            return Object.entries(agingBuckets).map(([k,v], i)=>(
              <div key={k} style={{flex:1,display:'flex',flexDirection:'column',alignItems:'center',gap:8}}>
                <div style={{height:110, width:'100%', display:'flex', alignItems:'flex-end', justifyContent:'center', position:'relative'}}>
                  <motion.div 
                    initial={{ height: 0 }} 
                  ...
                  <span style={{position:'absolute', top:-20, left:'50%', transform:'translateX(-50%)', fontSize:11, fontWeight:800, color:'#1e293b'}}>{v}</span>
                </div>
